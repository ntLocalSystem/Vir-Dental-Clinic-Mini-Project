...
class MainUser:
    def __init__(self, parent):
        ...
        self.frame_refresh.grid(row=0, column=1, sticky='nsew')
        ...
        ttk.Label(frame_refresh_add_doc, text='Enter Details :', font=('Times', 14, 'bold')).grid(row=0, column=0, columnspan=4, pady=(8, 35), padx=(30, 0), sticky='w')
